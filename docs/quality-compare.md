...
In dual-manifest mode, domain labels appear above each quality dropdown. When both URLs share the same second-level domain, the distinguishing subdomain prefix is shown instead (e.g. "cdn1-east" vs "cdn2-west"). Clicking a label copies the URL.
